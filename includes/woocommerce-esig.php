...
class ESIG_WOOCOMMERCE {
	...
	private static function single_activate() {
        ...
        {
			update_option('WP_ESignature__woocommerce_documentation','https://www.approveme.me/wp-digital-signature-plugin-docs/article/woocommerce-add-on/');
            
        }
        else
        {
           
			add_option('WP_ESignature__woocommerce_documentation','https://www.approveme.me/wp-digital-signature-plugin-docs/article/woocommerce-add-on/');
        }
	}
